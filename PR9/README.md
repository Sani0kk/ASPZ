...
### Опис
Програма зчитує вміст `/etc/passwd` через `getent passwd` і визначає звичайних користувачів (UID > 1000, крім поточного).
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма намагається отримати права root і виводить вміст `/etc/shadow`.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма створює файл, копіює його як root і тестує зміну/видалення від звичайного користувача.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма виконує `whoami` і `id` для виведення інформації про користувача та його групи.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма створює файл, змінює його права як root і тестує доступ від звичайного користувача.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма виконує `ls -l` для `/home/san`, `/usr/bin` і `/etc`, показуючи права та симулюючи спроби читання.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
...
### Опис
Програма створює файл без прав і тестує можливість його прочитання.
### Код
```c
#include <stdio.h>
#include <stdlib.h>
